...
public class returnBookController {
    ...
    void returnBookOnAction(ActionEvent event) {
        ...
        if (a > 0){
            if (b > 0) {
                dataBaseHandler.returnBook(book);
                dataBaseHandler.returnClient(client);
                labelResult.setText("Книга успешно взята у клиента - " + client.getFIO());
                dataBaseHandler.addResult(book,client, Operation.Возврат);
                //=== добавление в файл
            ...
            labelResult.setText("Данная книга не числится в нашей библиотеке");
        }
